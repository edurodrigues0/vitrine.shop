      ...
      <div className="flex flex-col items-center justify-center p-6 md:p-10 lg:p-12 bg-gradient-to-br from-blue-50/50 via-purple-50/30 to-pink-50/50 dark:from-blue-950/20 dark:via-purple-950/10 dark:to-pink-950/20 relative z-10">
        <div className="w-full max-w-md space-y-6">
          ...
          <div className="flex items-center gap-1.5">
            <div className="select-none inline-flex items-center justify-center gap-2.5 font-bold text-2xl group">
              ...
              <span className="font-bold bg-gradient-to-r from-purple-600 via-purple-600 to-primary bg-clip-text text-transparent bg-[length:200%_auto] group-hover:bg-[length:100%_auto] transition-all duration-500">
                Vitrine.shop
              </span>
            </div>
